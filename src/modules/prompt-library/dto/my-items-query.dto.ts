...
// Query DTO for GET /v1/prompt/my-items — caller's own packages bucketed by the LATEST version's
...
export class MyItemsQueryDto {
  @ApiProperty({ description: 'Lifecycle bucket, matched against the latest version state', enum: PromptVersionState })
  @IsEnum(PromptVersionState)
  readonly status: PromptVersionState;
