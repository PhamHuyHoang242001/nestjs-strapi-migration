...
describe('BiPaymentDocumentController perm mapping', () => {
  ...
  it('list gắn view/upload/upload_recon', () =>
    expect(getPerm('list')).toEqual(['bp_program_view', 'bp_program_upload', 'bp_program_upload_recon', 'bp_program_content_view']));
  it('details gắn view/upload/upload_recon', () =>
    expect(getPerm('details')).toEqual(['bp_program_view', 'bp_program_upload', 'bp_program_upload_recon', 'bp_program_content_view']));
  it('download gắn view/upload/upload_recon', () =>
    expect(getPerm('download')).toEqual(['bp_program_view', 'bp_program_upload', 'bp_program_upload_recon', 'bp_program_content_view']));
  ...
  it('stats gắn view/upload/upload_recon', () =>
    expect(getPerm('stats')).toEqual(['bp_program_view', 'bp_program_upload', 'bp_program_upload_recon', 'bp_program_content_view']));
  it('uploadStatus gắn view/upload/upload_recon', () =>
    expect(getPerm('uploadStatus')).toEqual(['bp_program_view', 'bp_program_upload', 'bp_program_upload_recon', 'bp_program_content_view']));
  ...
  it('userApproved gắn view/upload/upload_recon', () =>
    expect(getPerm('userApproved')).toEqual(['bp_program_view', 'bp_program_upload', 'bp_program_upload_recon', 'bp_program_content_view']));
  it('userRejected gắn view/upload/upload_recon', () =>
    expect(getPerm('userRejected')).toEqual(['bp_program_view', 'bp_program_upload', 'bp_program_upload_recon', 'bp_program_content_view']));
