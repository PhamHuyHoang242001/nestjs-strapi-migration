...
const VERSION_TAG_TABLE: Record<AssetHubWorkspace, { table: string; fk: string }> = {
  ...
  'api-catalog': { table: 'ai_api_catalog_version_tags', fk: 'api_catalog_version_id' },
};
...
const RESPONSIBLE_TABLE: Record<AssetHubWorkspace, { table: string; fk: string }> = {
  ...
  'api-catalog': { table: 'ai_api_catalog_package_responsibles', fk: 'api_catalog_package_id' },
};
