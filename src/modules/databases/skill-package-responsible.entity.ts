...
// PIC (person-in-charge) link between a user and a skill package. Relation-free by design:
...
@Entity('skill_package_responsibles')
@Index(['skill_package_id'])
@Index(['user_id'])
export class SkillPackageResponsible extends BaseSoftDeleteEntity {
  @Column({ type: 'int' })
